# Indent + AWS Lambda and Supabase

This repository contains an integration between Supabase and [Indent](https://indent.com). Once deployed, you will be able to use this integration with Indent to:
...
<details><summary><strong>3. Connecting to Supabase</strong></summary>
...
Visit <a href="https://github.com/indentapis/template-aws-lambda-supabase" target="_blank">this link</a> to our documentation for information on setting up GitHub Secrets in this repository.
